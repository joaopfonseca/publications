...
\hl{Recently, synthetic data generation techniques gathered attention among ML
...
\begin{figure}[t]
	\centering
	\includegraphics[width=\linewidth]{../analysis/al-example}
    \caption{%
        \hl{Illustration of the different acquisition processes in AL using a
...
\hl{Figure}~\ref{fig:al-example}\hl{ illustrates the difference across AL
