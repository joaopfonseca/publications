...
The experiment was implemented using the Python programming language, along
with the Python libraries Scikit-Learn~\cite{Pedregosa2011},
Imbalanced-Learn~\cite{JMLR:v18:16-365}, Geometric-SMOTE~\cite{Douzas2019},
Research-Learn and ML-Research libraries. All functions, algorithms,
experiments, and results are provided in the project's GitHub repository
(https://github.com/joaopfonseca/publications/). The original datasets used in
this study are publicly available in open data repositories. They were
retrieved from OpenML and the UCI Machine Learning Repository. 
