...
% Probability density function estimation + Distribution approximation
...
directly to feature $v \in V, |V|=m$ via a single edge are known as the parent
...
x^s_{i, 1}, \ldots, x^s_{i, v-1}, x^s_{i-1, v+1}, \dots, x^s_{i-1, m})$.
