...
\begin{enumerate}
    ...
    \item Scope. Considers the usage of the original dataset's properties.
        ...
        statistical properties of $\mathcal{D}^r$, or attempt to replicate
        specific relationships found in $\mathcal{D}^r$ are considered to have
...
\begin{longtable}{rcccccccc}
    \caption{Analysis of synthetic data generation models discussed in this work.}
    ...
    \bottomrule
    \endlastfoot
      SynSys~\cite{dahmen2019synsys} & DP & Healthcare &   &  &  & \\
      CTGAN~\cite{xu2019modeling} & & & Network-based & & Feature & Global \\
      Sensegen~\cite{alzantot2017sensegen} & DP \\
      SDV~\cite{patki2016synthetic} & DP \\
...
\subsection{Differentially Private Synthetic Data}~\label{sec:data-privacy}

SynSys~\cite{dahmen2019synsys}, Sensegen~\cite{alzantot2017sensegen}, The
Synthetic Data Vault~\cite{patki2016synthetic}, MST~\cite{mckenna2021winning},
SuperQUAIL~\cite{rosenblatt2020differentially}
