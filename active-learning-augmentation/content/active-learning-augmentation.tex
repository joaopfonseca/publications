...
\begin{abstract}
    ...
    classification performance and data selection efficiency.\footnote{
        \hl{All the code and preprocessed data developed for this study is
        available at}
...
\hl{Recently, data augmentation gathered attention among ML researchers due to
...
1. Wu, X., Zheng, W., Xia, X., \& Lo, D. (2021). Data Quality Matters: A Case
Study on Data Label Correctness for Security Bug Report Prediction. IEEE
transactions on software engineering, 1. doi: 10.1109/TSE.2021.3063727

2. Li, J., Xu, K., Chaudhuri, S., Yumer, E., Zhang, H.,... Guibas, L. (2017).
GRASS: generative recursive autoencoders for shape structures. ACM
transactions on graphics, 36(4), 1-14. doi: 10.1145/3072959.3073637

3. Zhang, K., Wang, Z., Chen, G., Zhang, L., Yang, Y., Yao, C.,... Yao, J.
(2022). Training effective deep reinforcement learning agents for real-time
life-cycle production optimization. Journal of Petroleum Science and
Engineering, 208, 109766. doi: https://doi.org/10.1016/j.petrol.2021.109766

4. Zheng, W., Liu, X., \& Yin, L. (2021). Sentence Representation Method Based
on Multi-Layer Semantic Network. Applied sciences, 11(3), 1316. doi:
10.3390/app11031316

"Open Set Domain Adaptation In Machinery Fault Diagnostics Using
Instance-Level Weighted Adversarial Learning"

"Deep learning based approach for bearing fault diagnosis" 

"Blockchain-Based Decentralized Federated Transfer Learning Methodology for
Collaborative Machinery Fault Diagnosis"
